...
const Dashboard = () => {
  ...
  const handleSendTip = async () => {
    ...
    try {
      await useDataStore.getState().sendTip(selectedCreator.id, parseFloat(tipData.amount), tipData.message)
              ...
              {isCreator && analytics && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="glass rounded-2xl p-6">
                    ...
                    <div className="font-accent text-3xl font-bold">${(analytics.totalEarnings || 0).toFixed(2)}</div>
                    ...
                    posts.filter(p => p.creator?.id === user.id).map((post) => (
                      <div key={post.id} className="card p-6">
                        <div className="flex items-center justify-between mb-4">
                          ...
                          {post.isPpv && (
                            <span className="badge badge-accent">PPV - ${post.ppvPrice}</span>
                          )}
                        </div>
                        <p className="text-gray-300 mb-4">{post.content}</p>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div>
                      <div className="font-accent text-2xl font-bold text-green-400">
                        ${(analytics?.monthlyRevenue || 0).toFixed(2)}
                      </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="font-accent font-semibold text-green-400">
                        ${(earnings?.fromSubscriptions || 0).toFixed(2)}
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                  ...
                  {isCreator && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input type="number" defaultValue={user?.subscriptionPrice || 9.99} className="input-field" step="0.01" />
                      </div>
                      <div>
